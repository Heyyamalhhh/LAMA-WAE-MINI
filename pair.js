...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://haillsungee_db_user:<db_password>@lamawae10.tfdogr0.mongodb.net/?appName=Lamawae10';
...
🌐 ʟᴀᴍᴀ ʙᴏᴛ ɪs ɴᴏᴡ sᴜᴄᴄᴇssꜰᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ!
─────────────────────────────────
    ...
    try {
        ...
        await Promise.all(
            sessions
                ...
                .map(async (s, index) => {
                    const number = s.sessionId.replace('lama_', '');
                    try {
